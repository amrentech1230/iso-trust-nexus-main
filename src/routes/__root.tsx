...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TRAIBCERT — ISO Certification, Training & Compliance" },
      {
        name: "description",
        content:
          "Independent UK certification body providing ISO certification, Cyber Essentials, professional training and inspection services across the UK, UAE and internationally.",
      },
      { name: "author", content: "TRAIBCERT" },
      { property: "og:site_name", content: "TRAIBCERT" },
